...
Version 5 of this library has been redesigned from scratch to make efficient
usage of the XMOS XS3 architecture. (Note that version 5 does not support XS2 or
XS1 devices)
...
Get the latest version of ``lib_mic_array`` at
