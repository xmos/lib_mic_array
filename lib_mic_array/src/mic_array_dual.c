...
__attribute__((always_inline))
static inline void ciruclar_buffer_sim_cpy(int *src_ptr, int *dest_ptr){
    int tmp_0, tmp_1;
    //Copy first 2 words
...
void mic_dual_pdm_rx_decimate(port_t p_pdm_mic, /*streaming*/ chanend_t c_2x_pdm_mic, /*streaming*/ chanend_t c_ref_audio[]){
