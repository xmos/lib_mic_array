...
using TMicArray =  mic_array::MicArray<MIC_ARRAY_CONFIG_MIC_COUNT,
                        mic_array::Decimator<MIC_ARRAY_CONFIG_MIC_COUNT>,
...
union UStg2_filter_state stg2_filter_state_mem;
union UPdmRx_out_block pdm_rx_out_block;
union UPdmRx_out_block_double_buf __attribute__((aligned (8))) pdm_rx_out_block_double_buf; // deinterleave() functions expect dword alignment
