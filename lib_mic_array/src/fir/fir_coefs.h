...
#define FIR_COMPENSATOR_DIV_2 (370194176)

extern const int g_third_stage_div_4_fir[252];
extern const int fir3_div_4_debug[128];
#define FIR_COMPENSATOR_DIV_4 (383351089)

extern const int g_third_stage_div_6_fir[378];
extern const int fir3_div_6_debug[192];
#define FIR_COMPENSATOR_DIV_6 (383230907)

extern const int g_third_stage_div_8_fir[504];
extern const int fir3_div_8_debug[256];
#define FIR_COMPENSATOR_DIV_8 (383662111)

extern const int g_third_stage_div_12_fir[756];
extern const int fir3_div_12_debug[384];
#define FIR_COMPENSATOR_DIV_12 (384203480)

extern const int g_third_stage_custom_voice_fir[126];
extern const int fir3_custom_voice_debug[64];
#define FIR_COMPENSATOR_CUSTOM_VOICE (357529772)
