...
#       > pytest path/to/this/dir/test_shutdown.py
######

from pathlib import Path
import subprocess

@pytest.mark.parametrize("pdmrx", ["pdmrx_isr", "pdmrx_thread"])
def test_shutdown(request, pdmrx):
  cwd = Path(request.fspath).parent
  xe_path = f'{cwd}/bin/{pdmrx}/tests_signal_shutdown_{pdmrx}.xe'
