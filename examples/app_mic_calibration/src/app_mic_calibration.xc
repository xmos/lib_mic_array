...
void mic_calib(streaming chanend c_ds_output_0, streaming chanend c_ds_output_1, chanend c){
    ...
    unsafe{
        ...
        decimator_config dc0 = {FRAME_SIZE_LOG2, 0, 0, 0, decimation_factor, fir_coefs[decimation_factor], data_0, 0, {0,0, 0, 0}};
        decimator_config dc1 = {FRAME_SIZE_LOG2, 0, 0, 0, decimation_factor, fir_coefs[decimation_factor], data_1, 0, {0,0, 0, 0}};
