...
#ifndef GOOD_TWO_STAGE_FILTER_H
#define GOOD_TWO_STAGE_FILTER_H

#include <stdint.h>

// Generated from good_2_stage_filter_int.pkl

#define CUSTOM_FILT_STAGE1_DECIMATION_FACTOR  (32)
#define CUSTOM_FILT_STAGE1_TAP_COUNT  (256)

uint32_t custom_filt_stage1_coef[CUSTOM_FILT_STAGE1_TAP_COUNT/2] =
{
...
int32_t custom_filt_stage2_coef[] =
{
